...
static void periph_Timer_IO_Init(Timer_list timerx,Timer_PWM_Channel_State CH1_State,Timer_PWM_Channel_State CH2_State,Timer_PWM_Channel_State CH3_State,Timer_PWM_Channel_State CH4_State)
{
	if(CH1_State == PWM_CH1_Enable)
	{
		...
		{
			case Timer_2:	GPIO_TIM2_PWMCH1_IO_Init();break;
			case Timer_3:	GPIO_TIM3_PWMCH1_IO_Init();break;
			case Timer_4:	GPIO_TIM4_PWMCH1_IO_Init();break;
			default: break;
		}
	}
	...
	if(CH2_State == PWM_CH2_Enable)
	{
		switch((uint8_t) timerx)
		{
			case Timer_2:	GPIO_TIM2_PWMCH2_IO_Init();break;
			case Timer_3:	GPIO_TIM3_PWMCH2_IO_Init();break;
			case Timer_4:	GPIO_TIM4_PWMCH2_IO_Init();break;
			default: break;
		}
	}
	...
	if(CH3_State == PWM_CH3_Enable)
	{
		switch((uint8_t) timerx)
		{
			case Timer_2:	GPIO_TIM2_PWMCH3_IO_Init();break;
			case Timer_3:	GPIO_TIM3_PWMCH3_IO_Init();break;
			case Timer_4:	GPIO_TIM4_PWMCH3_IO_Init();break;
			default: break;
		}
	...
	if(CH4_State == PWM_CH4_Enable)
	{
		switch((uint8_t) timerx)
		{
			case Timer_2:	GPIO_TIM2_PWMCH4_IO_Init();break;
			case Timer_3:	GPIO_TIM3_PWMCH4_IO_Init();break;
			case Timer_4:	GPIO_TIM4_PWMCH4_IO_Init();break;
			default: break;
		}
	}
}
