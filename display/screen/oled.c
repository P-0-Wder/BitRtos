...
//	OLED_WR_Byte(0xA1,OLED_CMD); //段重定义设置,bit0:0,0->0;1,0->127;a0左右反置，a1正常
//	OLED_WR_Byte(0xC0,OLED_CMD); //设置COM扫描方向;bit3:0,普通模式;1,重定义模式 COM[N-1]->COM0;N:驱动路数；c0上下反置，c8正常
	
	OLED_WR_Byte(0xA0,OLED_CMD); //段重定义设置,bit0:0,0->0;1,0->127;a0左右反置，a1正常
	OLED_WR_Byte(0xC8,OLED_CMD); //设置COM扫描方向;bit3:0,普通模式;1,重定义模式 COM[N-1]->COM0;N:驱动路数；c0上下反置，c8正常
